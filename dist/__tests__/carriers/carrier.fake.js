...
export function createRandomCarrier() {
    var _id = new mongoose.Types.ObjectId();
    var published = faker.datatype.boolean();
    var name = faker.lorem.words(2);
    var description = faker.lorem.sentence(10);
    var price = faker.datatype.float({ max: 10, precision: 0.1 });
...
export function createRandomCarriers(length) {
    return __awaiter(this, void 0, void 0, function () {
        var response, i, carrier;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4, CarrierModel.create(__assign({}, carrier))
                            .then(function (docs) {
