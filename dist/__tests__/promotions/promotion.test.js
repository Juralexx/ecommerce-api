...
describe('Promotions', function () {
    describe('Get all promotions', function () {
        it('Should return all promotions', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    describe('Get promotion', function () {
        describe('Promotion does not exist', function () {
            it('should return : status => 400', function () { return __awaiter(void 0, void 0, void 0, function () {
                var id, statusCode;
        ...
        describe('Promotion does exist', function () {
            it('Should return : status => 200', function () { return __awaiter(void 0, void 0, void 0, function () {
                var id, _a, body, statusCode;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            id = '645065ab5cab25512953d255';
                            return [4, supertest(root)
                                    .get("/api/promotions/".concat(id))
                                    .set('Authorization', process.env.API_KEY)];
                        case 1:
    ...
    describe('Promotion CRUD', function () {
        var PromotionID = new String();
        it('Should create promotion', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, supertest(root)
                            .post('/api/promotions/create')
                            .send(__assign({}, promotion))
                            .set('Authorization', process.env.API_KEY)
                            .then(function (res) {
        ...
        it('Should update promotion', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, supertest(root)
                            .put("/api/promotions/".concat(PromotionID, "/update"))
        ...
        it('Should delete promotion', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, supertest(root)
                            .delete("/api/promotions/".concat(PromotionID, "/delete"))
                            .set('Authorization', process.env.API_KEY)
                            .then(function (res) {
                            var body = res.body, statusCode = res.statusCode;
                            expect(statusCode).toBe(200);
