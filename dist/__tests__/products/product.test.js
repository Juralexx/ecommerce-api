    ...
    describe('Product CRUD', function () {
        ...
        it('Should update product', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, supertest(root)
                            .put("/api/products/".concat(ProductID, "/update"))
        ...
        it('Should delete product', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, supertest(root)
                            .delete("/api/products/".concat(ProductID, "/delete"))
                            .set('Authorization', process.env.API_KEY)
                            .then(function (res) {
                            var body = res.body, statusCode = res.statusCode;
                            expect(statusCode).toBe(200);
