...
describe('Authentication', function () {
    ...
    describe('Register', function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, supertest(root)
                            .put("/api/users/".concat(UserID, "/update"))
                            .set('Authorization', process.env.API_KEY)
                            .send({ role: 'editor' })
                            .then(function (res) {
                            var body = res.body, statusCode = res.statusCode;
        ...
        it('Should delete user', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, supertest(root)
                            .delete("/api/users/".concat(UserID, "/delete"))
                            .set('Authorization', process.env.API_KEY)
                            .then(function (res) {
                            var body = res.body, statusCode = res.statusCode;
                            expect(statusCode).toBe(200);
    ...
    describe('Get user', function () {
        ...
        describe('User does exist', function () {
            it('Should return user', function () { return __awaiter(void 0, void 0, void 0, function () {
                var id, _a, body, statusCode;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            id = '643b2340567ce6fc51da39ec';
                            return [4, supertest(root)
                                    .get("/api/users/".concat(id))
                                    .set('Authorization', process.env.API_KEY)];
                        case 1:
