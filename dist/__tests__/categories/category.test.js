...
describe('Category', function () {
    ...
    describe('Get category', function () {
        describe('Category does not exist', function () {
    ...
    describe('Category CRUD', function () {
        var CategoryID = new String();
        it('Should create category', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, supertest(root)
                            .post("/api/categories/create")
                            .send(__assign({}, category))
                            .set('Authorization', process.env.API_KEY)
                            .then(function (res) {
        ...
        it('Should update category', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, supertest(root)
                            .put("/api/categories/".concat(CategoryID, "/update"))
        ...
        it('Should delete category', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, supertest(root)
                            .delete("/api/categories/".concat(CategoryID, "/delete"))
                            .set('Authorization', process.env.API_KEY)
                            .then(function (res) {
                            var body = res.body, statusCode = res.statusCode;
                            expect(statusCode).toBe(200);
