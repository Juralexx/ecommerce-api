...
function getRandomProducts() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4, ProductModel.aggregate([{ $sample: { size: randomIntFromInterval(1, 8) } }])];
                case 1:
                    products = _a.sent();
...
export function createRandomCart() {
    return __awaiter(this, void 0, void 0, function () {
        var _id, products;
        return __generator(this, function (_a) {
            switch (_a.label) {
...
export function createRandomCarts(length) {
    return __awaiter(this, void 0, void 0, function () {
        var response, i, cart;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4, createRandomCart()];
                case 2:
                    cart = _a.sent();
                    return [4, CartModel.create(__assign({}, cart))
                            .then(function (docs) {
