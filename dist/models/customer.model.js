...
var CustomerModel = new mongoose.Schema(__assign(__assign({}, DefaultUserModel.obj), { title: {
        type: String,
        enum: ['M', 'Mme'],
        required: true,
        default: 'M'
        ...
        address: {
            ...
            postcode: {
                ...
                required: true,
                validate: {
                    validator: function (val) { return isValidPostcode(val); },
...
CustomerModel.pre("save", function (next) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4, bcrypt.genSalt()];
                case 1:
                    salt = _b.sent();
                    _a = this;
                    return [4, bcrypt.hash(this.password, salt)];
                case 2:
                    _a.password = _b.sent();
                    next();
                    return [2];
